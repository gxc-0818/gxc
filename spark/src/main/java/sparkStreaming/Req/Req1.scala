...
object Req1 {
  ...
  def main(args: Array[String]): Unit = {
    val sparkConf: SparkConf = new SparkConf().setAppName("KafkaConsumer1").setMaster("local[8]")
    ...
    val reduceRdd: DStream[((String, String, String), Int)] = datas.transform {
      rdd => {
        //加载黑名单
